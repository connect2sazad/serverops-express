...
// get all user roles
router.get(USERROLES, authenticate, authorizeRoles('admin'), async (req, res, next) => {
...
router.get(USERROLE_ID, authenticate, authorizeRoles('admin'), async (req, res, next) => {
...
// create a user role
router.post(USERROLES, authenticate, authorizeRoles('admin'), validate(UserRoleCreateSchema), async (req, res, next) => {
...
router.put(USERROLE_ID, authenticate, authorizeRoles('admin'), validate(UserRoleUpdateSchema), async (req, res, next) => {
...
// ==================================
// delete user role
router.delete(USERROLE_ID, authenticate, authorizeRoles('admin'), async (req, res, next) => {
...
// enable user role
router.put(USERROLE_ID_ENABLE, authenticate, authorizeRoles('admin'), async (req, res, next) => {
  req.body = {
    status: true
  };
...
// disable user role
router.put(USERROLE_ID_DISABLE, authenticate, authorizeRoles('admin'), async (req, res, next) => {
  req.body = {
    status: false
  };
  await user_role_controller.setStatus(req, res, next);
...
router.put(USERROLE_ID_REMARKS, authenticate, authorizeRoles('admin'), async (req, res, next) => {
...
router.put(USERROLE_ID_TAGS, authenticate, authorizeRoles('admin'), async (req, res, next) => {
...
router.delete(USERROLE_ID_REMOVE_REMARKS, authenticate, authorizeRoles('admin'), async (req, res, next) => {
...
router.delete(USERROLE_ID_REMOVE_TAGS, authenticate, authorizeRoles('admin'), async (req, res, next) => {
